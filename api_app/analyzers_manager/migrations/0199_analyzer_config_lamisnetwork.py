...
plugin = {
    "python_module": {
        ...
        "module": "lamisnetwork.LamisNetwork",
        "base_path": "api_app.analyzers_manager.observable_analyzers",
    },
    "name": "LamisNetwork",
    "description": "Lamis Network IP Intelligence and Fraud Score API",
    "disabled": False,
    "soft_time_limit": 30,
    "routing_key": "default",
...
params = [
    {
        ...
        "name": "api_key_name",
        "type": "str",
        "description": "Lamis Network API Key",
        "is_secret": True,
        "required": True,
    }
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("analyzers_manager", "0198_remove_feodo_tracker_analyzer"),
    ]
